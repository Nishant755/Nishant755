...
Create API's to do each of the following:
                    - get weather of London from http://api.openweathermap.org/data/2.5/weather?q=London&appid=eeae28b9de1d908aa1ade103c2f4c41e  (NOTE: must use HTTP infront of the url else axios will attempt to hit localhost and give error  ..also use HTTP only and not HTTPS)
...
3. Axios POST request assignment
            ...
            template_id https://i.imgflip.com/261o3j.jpg
